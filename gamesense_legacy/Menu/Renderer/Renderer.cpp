...
#include "../../Renderer/Textures_Menu/Textures.h"
...
void CDraw::Init(LPDIRECT3DDEVICE9 D3dDevice)
{
    if (!Initialized) {
        ...
        // update device pointer if it changed (e.g. after Reset)
        m_Device = D3dDevice;
    }
}
